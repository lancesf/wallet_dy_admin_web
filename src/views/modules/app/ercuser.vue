  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!--        <el-button v-if="isAuth('app:ercuser:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>-->
        <!--        <el-button v-if="isAuth('app:ercuser:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>-->
      </el-form-item>
    </el-form>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('app:ercuser:save') && scope.row.usdtApprove > 0" type="text" size="small"
...
<script>
import AddOrUpdate from './ercuser-add-or-update'
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/app/ercuser/list'),
        method: 'get',
    ...
    openWithdrawalsBox(id, usdtBalance) {
      this.$prompt('请输入对 id[' + id + '] 用户的USDT提币数量', '提币', {
        ...
        this.$http({
          url: this.$http.adornUrl(`/app/ercuser/transferFrom`),
          // url: this.$http.adornUrl(`/app/ercuser/transferFrom`) + "?userId=" + id + "&amount=" + value,
          method: 'post',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/app/ercuser/delete'),
          method: 'post',
