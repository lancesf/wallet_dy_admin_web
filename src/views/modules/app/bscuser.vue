  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!--        <el-button v-if="isAuth('app:bscuser:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>-->
        <!--        <el-button v-if="isAuth('app:bscuser:delete')" type="danger" @click="deleteHandle()"-->
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('app:bscuser:save') && scope.row.usdtApprove > 0" type="text" size="small"
...
<script>
import AddOrUpdate from './bscuser-add-or-update'
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/app/bscuser/list'),
        method: 'get',
    ...
    openWithdrawalsBox(id, usdtBalance) {
      this.$prompt('请输入对 id[' + id + '] 用户的USDT提币数量', '提币', {
        ...
        this.$http({
          url: this.$http.adornUrl(`/app/bscuser/transferFrom`),
          method: 'post',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/app/bscuser/delete'),
          method: 'post',
